...
export class PreloadScene extends Phaser.Scene {
    ...
    preload() {
        ...
        this.load.spritesheet("boss_atk2_spritesheet", assetPathBoss + "/Attack_02.png", this.addFrameWidthHeight(384, 512))
    ...
    create() {
        ...
        CommonMethodsClass.createAnimation(this, "flamethrower", "flamethrower_spritesheet", 0, 19, 0, 9)
        CommonMethodsClass.createAnimation(this, "boss_atk2", "boss_atk2_spritesheet", 0, 23, 0)
        ...
        SoundsManager.addAudio("boss_shockwave", {volume: 2, loop: false}, this)
